...
npm run announce-card # Render the release announcement card images (see scripts/announce-card/README.md — requires Playwright; normally run by the release announcement workflow)
