...
• メモパネル: サイドパネル下部に折りたたみ可能なメモ欄を常備、高さも自由に調整可能
• 色覚対応カラープリセット: 第1色覚・第2色覚・第3色覚向けのカラーテーマを用意
...
• Memo Panel: A collapsible memo area at the bottom of the side panel, with adjustable height for quick note-taking
