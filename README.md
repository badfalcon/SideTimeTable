...
- **Calendar Grouping**: Organize calendars into custom groups (e.g., "Work", "Personal") and switch views with one click.
...
- **カレンダーグループ**: カレンダーを「仕事」「プライベート」などにグループ化し、ワンクリックで表示切替。
